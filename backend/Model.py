...
-> Respond with 'perform task (app) (task) (arguments)' if a query is a task to be performed task can include-click,type,hotkey,copy,paste,scroll, move,press,select,save,tab,close,refresh,undo,redo,ind,print,new,cut excepting opening or closing an application'.
